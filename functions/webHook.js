...
exports.stripeWebhook = onRequest(
  { secrets: ["STRIPE_SECRET_KEY", "STRIPE_WEBHOOK_SECRET"], runtimeOptions: { memory: "256MB", timeoutSeconds: 60 } },
  async (req, res) => {
    // IMPORTANT: Ensure you have access to the raw body
    // If using Firebase Functions v2 with express, you might need to disable body parsing. For now, assume req.rawBody is available.
    ...
    switch (event.type) {
      ...
      //   // Update Firestore accordingly, for example, set subscriptionStatus to "canceled"
      //   break;
